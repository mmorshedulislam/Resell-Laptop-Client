              ...
              <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                <div className="text-center my-3 flex flex-col justify-center items-center">
                  ...
                  <h5 className="font-semibold mt-2">
                    {user?.displayName} - {isSeller && "Seller"}{" "}
                    {isBuyer && "Buyer"} {isAdmin && "Admin"}
                  </h5>
                  <p>{user?.email}</p>
                </div>
                <ul class="space-y-2">
                    ...
                    <>
                      <li>
                        <Link
                          ...
                          class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
                          <BsCart4 className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                    ...
                    <>
                      ...
                      <li>
                        <Link
                          ...
                          class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
                          <FaUserCheck className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                          <span class="flex-1 ml-3 whitespace-nowrap">
                            Sellers
                          </span>
                        </Link>

...
const AboutUs = () => {
  return (
    <div className="py-20 px-10 bg-[#f8f5f5] text-[#112A46] mb-5">
      <h2 className="text-5xl text-center">About Us</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 my-10">
        <div>
          <img className="w-full" src="https://images.unsplash.com/photo-1517336714731-489689fd1ca8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YXBwbGUlMjBsYXB0b3B8ZW58MHx8MHx8&w=1000&q=80" alt="" />
        </div>
